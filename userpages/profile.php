...
// Profiles can be opened for another user through ?id=; otherwise show the current user.
...
$userSportIds = array_map(function ($row) {
    return (int) $row['sportid']; }, $userSports);
                ...
                <div class="community-card">
                    <details class="community-people">
                        <summary>
                            <span>
                                <span
                                    class="community-value"><?php echo htmlspecialchars($followerCount, ENT_QUOTES); ?></span>
                                    ...
                                    <a class="community-person" href="profile.php?id=<?php echo (int) $person['userid']; ?>">
                                        ...
                                        <span class="community-person-info">
                                            ...
                                            <?php if (!empty($person['username'])): ?>
                                                <span
                                                    class="community-person-username">@<?php echo htmlspecialchars($person['username'], ENT_QUOTES); ?></span>
                                            <?php endif; ?>
                                        </span>
                                    </a>
                                <?php endforeach; ?>
                ...
                <div class="community-card">
                    <details class="community-people">
                        <summary>
                            <span>
                                <span
                                    class="community-value"><?php echo htmlspecialchars($followingCount, ENT_QUOTES); ?></span>
                            ...
                            <?php foreach ($allSports as $sport): ?>
                                <label class="sport-select-item">
                                    <input type="checkbox" name="sports[]" value="<?php echo (int) $sport['sportid']; ?>"
                                        <?php if (in_array((int) $sport['sportid'], $userSportIds, true))
                                            echo 'checked'; ?>>
                                    ...
                                    <?php endif; ?>
                                    <span
                                        class="sport-select-name"><?php echo htmlspecialchars($sport['name'], ENT_QUOTES); ?></span>
                                </label>
                            <?php endforeach; ?>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    // PHP arrays are serialized into Chart.js datasets.
